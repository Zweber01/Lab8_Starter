...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const prodItems = await page.$$('product-item');
    var shadow = prodItems.shadowRoot;
    var button1 = shadow.querySelector('button');
    expect(button1.innerText.jsonValue());
    // TODO - Step 2
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for(let i = 0; i < prodItems.length; i++){
      ...
      expect(button).toBe('Remove from Cart');
    }
    var count = document.querySelector('cart-count');
    expect(count).toBe(20);
    // TODO - Step 4
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    expect(buttonText.textContent).toBe("Add to Cart");
    var count = document.querySelector('cart-count');
    expect(count).toBe(0);
    // TODO - Step 7
